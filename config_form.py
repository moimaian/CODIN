...
class ConfiguracaoDinamica(QWidget):
    ...
    def __init__(self, codyn_dir, tabs):
        ...
        self.box_x = QLineEdit("10.00000")
        self.box_y = QLineEdit("10.00000")
        self.box_z = QLineEdit("10.00000")
        self.t_int = QLineEdit("2")        
        self.n_threads = QLineEdit(str(os.cpu_count()))


        # -------- Adicionando campos ao formulário --------
        form_layout.addRow("Production time (ns):", self.t_ns)
        ...
        form_layout.addRow("Box X Size (nm):", self.box_x)
        form_layout.addRow("Box Y Size (nm):", self.box_y)
        form_layout.addRow("Box Z Size (nm):", self.box_z)
    ...
    def salvar_dados(self):
        try:
            ...
            form_data = [
                ...
                self.t_int.text(),
                self.n_threads.text(),
                self.lig_dir.text().strip(),
                self.prot_dir.text().strip()
            ]
            ...
            file_path = os.path.join(self.codyn_dir, ".form_data.txt")
